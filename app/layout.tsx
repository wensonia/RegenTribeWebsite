      ...
      <body>
        ...
        >
          ...
          >
            ...
            >
              ...
              {/* Site map — every page on the site */}
              {[
                {
                  heading: 'Explore',
                  links: [
                    ...
                    { label: 'Contact', href: 'mailto:hello@regentribe.co' },
                  ],
                },
                {
                  heading: 'What We Do',
                  links: [
                    ...
                    { label: 'RegenHood Zero', href: '/regenhoodzero' },
                  ],
                },
                {
                  heading: 'Tools',
        ...
        <style dangerouslySetInnerHTML={{ __html: `
          @media (max-width: 900px) {
            .footer-grid { grid-template-columns: repeat(2, 1fr) !important; gap: 32px !important; padding-bottom: 40px !important; }
          }
