...
const modulesV2 = [
  ...
  { id: '09', name: 'Match-making', purpose: 'AI-powered pairing of people to communities, collaborators to projects, and skills to needs. The intelligence layer that puts the right people in the right places at the right time.',                                     status: 'Building', color: 'var(--green)'  },
