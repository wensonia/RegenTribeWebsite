...
const tools = [
  ...
  },
  {
    ...
    skills:   [],
    status:   'Active',
    builders:     'Ian Tarrea · Vitali Bohush',
    contributors: 'collective',
...
const modulesV2 = [
  ...
  { id: '02', name: 'Neighborhood Directory', purpose: 'Explore regenerative neighborhoods on a live map. Check in as a visitor, leave a guest book entry, and find the communities that match your values and way of life.',                                              status: 'Building', color: 'var(--green)'  },
  ...
  { id: '04', name: 'Resources & Tools',      purpose: 'A curated, community-powered archive of regenerative resources — articles, tools, case studies, guides, and templates. Searchable and filterable, continuously growing.',                                          status: 'Building', color: 'var(--green)'  },
  { id: '05', name: 'Movement Updates',       purpose: 'A living timeline of the movement. Share updates, celebrate milestones, follow the communities and people you care about — the pulse of regenerative neighborhood life.',                                          status: 'Building', color: 'var(--green)'  },
  ...
  { id: '08', name: 'Operations',             purpose: 'Internal operations for community teams — project boards, task assignment, budget tracking, and reporting. Everything a neighborhood needs to function as a living, self-organizing system.',                      status: 'Planned',  color: 'var(--blue)'   },
  { id: '09', name: 'Community Glue',         purpose: 'AI-powered pairing of people to communities, collaborators to projects, and skills to needs. The intelligence layer that puts the right people in the right places at the right time.',                           status: 'Building', color: 'var(--green)'  },
  { id: '10', name: 'Governance',             purpose: 'An AI-facilitated governance layer for community decision-making. Mediates conflicts, surfaces proposals, and guides neighborhoods through transparent, values-aligned decisions.',                                 status: 'Planned',  color: 'var(--blue)'   },
  { id: '11', name: 'Contribution Tracking',  purpose: 'Contribution tracking, reputation points, and badges that recognize participation across the ecosystem. Makes regenerative action visible, rewarding, and portable across communities.',                          status: 'Planned',  color: 'var(--blue)'   },
  { id: '12', name: 'AI Personal Assistant',  purpose: 'Your personal AI guide through the Regen Tribe ecosystem. Answers questions, surfaces opportunities, tracks your journey, and helps you navigate toward the life you are building.',                               status: 'Planned',  color: 'var(--pink)'   },
